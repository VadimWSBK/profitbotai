...
export const cssgenerator = String.raw`
  ...
  function getWidgetCSS(config, scopeId) {
    ...
    var cssArray = [
      ...
      /* Checkout preview: HTML table with product image column */
      '.pb-checkout-preview { margin-top: 12px; }',
      '.pb-checkout-title { font-size: 18px; font-weight: 700; margin: 0 0 12px 0; color: #111827; }',
      '.pb-checkout-table-wrap { overflow-x: auto; margin-bottom: 4px; }',
      '.pb-checkout-table { width: 100%; border-collapse: collapse; font-size: 14px; }',
      '.pb-checkout-table th { text-align: left; padding: 8px 10px; border-bottom: 1px solid rgba(0,0,0,0.12); font-weight: 600; color: #374151; background: rgba(0,0,0,0.04); }',
      '.pb-checkout-table td { padding: 10px; border-bottom: 1px solid rgba(0,0,0,0.08); vertical-align: middle; }',
      '.pb-checkout-table .pb-checkout-tr:last-child td { border-bottom: none; }',
      '.pb-checkout-th-image { width: 72px; text-align: center; }',
      '.pb-checkout-td-image { width: 72px; text-align: center; }',
      '.pb-product-image { width: 56px; height: 56px; border-radius: 8px; object-fit: cover; background: rgba(0,0,0,0.06); display: inline-block; vertical-align: middle; }',
      '.pb-product-image.pb-image-placeholder { display: inline-block; min-width: 56px; min-height: 56px; background: rgba(0,0,0,0.06); border-radius: 8px; }',
      '.pb-product-title { font-weight: 700; font-size: 14px; color: #111827; }',
      '.pb-checkout-td-unit { color: #6b7280; white-space: nowrap; }',
      '.pb-checkout-td-qty { text-align: center; white-space: nowrap; }',
      '.pb-checkout-td-total { text-align: right; white-space: nowrap; color: #111827; }',
      '.pb-checkout-hr { border: none; border-top: 1px solid rgba(0,0,0,0.12); margin: 12px 0; }',
      '.pb-checkout-summary-table { width: 100%; border-collapse: collapse; font-size: 14px; }',
      '.pb-checkout-summary-table .pb-summary-row td { padding: 4px 0; }',
      '.pb-checkout-summary-table .pb-summary-row td:last-child { text-align: right; font-weight: 500; }',
      '.pb-checkout-summary-table .pb-subtotal td { padding-top: 8px; }',
