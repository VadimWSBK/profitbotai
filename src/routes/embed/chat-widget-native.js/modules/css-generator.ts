...
export const cssgenerator = String.raw`
  ...
  function getWidgetCSS(config, scopeId) {
    ...
    var cssArray = [
      ...
      /* Checkout preview: card-style line items (image + qty badge, name, unit price, total) */
      '.pb-checkout-preview { margin-top: 12px; }',
      '.pb-checkout-title { font-size: 18px; font-weight: 700; margin: 0 0 12px 0; color: #111827; }',
      '.pb-checkout-line-items { display: flex; flex-direction: column; gap: 14px; margin-bottom: 8px; }',
      '.pb-checkout-line-item { display: flex; align-items: flex-start; gap: 12px; }',
      ...
      '.pb-checkout-line-item-details .pb-checkout-price-block { display: flex; flex-direction: column; gap: 2px; }',
      '.pb-checkout-line-item-details .pb-checkout-price-label { opacity: 0.85; font-size: 0.9em; color: #6b7280; }',
      '.pb-checkout-line-item-details .pb-checkout-price-value { font-weight: 600; color: #111827; }',
