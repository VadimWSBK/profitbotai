...
export const AGENT_TOOL_LABELS: Record<AgentToolId, string> = {
	...
	calculate_bucket_breakdown: 'Calculate bucket breakdown (DIY quote)',
	...
	shopify_create_discount: 'Shopify: Apply discount (NZ10, NZ15, NZ20)',
