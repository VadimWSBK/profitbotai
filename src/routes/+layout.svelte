...
<div class="flex min-h-screen bg-gray-50">
	...
	<aside class="w-16 flex flex-col items-center py-4 bg-gray-900 text-gray-400 shrink-0">
		...
		<a href="/contacts" class="p-3 rounded-lg mt-1 transition-colors {(($page.url.pathname as string) === '/contacts' ? 'bg-gray-800 text-white' : 'hover:bg-gray-800 hover:text-white')}" title="Contacts">
			<svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/></svg>
		</a>
		<a href="/leadflow" class="p-3 rounded-lg mt-1 transition-colors {(($page.url.pathname as string) === '/leadflow' ? 'bg-gray-800 text-white' : 'hover:bg-gray-800 hover:text-white')}" title="Leadflow">
			<svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17V7m0 10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2h2a2 2 0 012 2m0 10a2 2 0 002 2h2a2 2 0 002-2M9 7a2 2 0 012-2h2a2 2 0 012 2m0 10V7m0 10a2 2 0 002 2h2a2 2 0 002-2V7a2 2 0 00-2-2h-2a2 2 0 00-2 2"/></svg>
		</a>
		<a href="/quote" class="p-3 rounded-lg mt-1 transition-colors {(($page.url.pathname as string) === '/quote' ? 'bg-gray-800 text-white' : 'hover:bg-gray-800 hover:text-white')}" title="Quote">
			<svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
		</a>
		<a href="/forms" class="p-3 rounded-lg mt-1 transition-colors {(($page.url.pathname as string).startsWith('/forms') ? 'bg-gray-800 text-white' : 'hover:bg-gray-800 hover:text-white')}" title="Forms">
			<svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"/></svg>
		</a>
		<div class="flex-1"></div>
		<a href="/integrations" class="p-3 rounded-lg mt-1 transition-colors {(($page.url.pathname as string) === '/integrations' ? 'bg-gray-800 text-white' : 'hover:bg-gray-800 hover:text-white')}" title="Integrations">
