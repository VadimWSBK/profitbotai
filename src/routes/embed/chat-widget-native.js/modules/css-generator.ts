...
export const cssgenerator = String.raw`
  ...
  function getWidgetCSS(config, scopeId) {
    ...
    var cssArray = [
      ...
      /* Checkout preview: table-form line items, no receipt icon */
      '.pb-checkout-preview { margin-top: 12px; }',
      '.pb-checkout-title { font-size: 18px; font-weight: 700; margin: 0 0 12px 0; color: #111827; }',
      '.pb-line-item { display: flex; align-items: center; gap: 12px; padding: 10px 0; border-bottom: 1px solid rgba(0,0,0,0.08); }',
      '.pb-line-item:last-of-type { border-bottom: none; }',
      '.pb-product-image { width: 64px; height: 64px; min-width: 64px; border-radius: 8px; object-fit: cover; background: rgba(0,0,0,0.06); }',
      '.pb-product-image.pb-image-placeholder { display: block; }',
      '.pb-product-details { flex: 1; min-width: 0; }',
      '.pb-product-title { font-weight: 700; font-size: 15px; margin-bottom: 4px; color: #111827; }',
      '.pb-product-meta { font-size: 13px; color: #6b7280; }',
      '.pb-product-qty { font-size: 13px; color: #374151; white-space: nowrap; }',
      '.pb-product-total { font-weight: 700; font-size: 15px; color: #111827; white-space: nowrap; }',
      ...
      '.pb-summary-row.pb-subtotal { margin-top: 4px; }',
      '.pb-summary-row.pb-savings { color: #059669; }',
      '.pb-summary-row.pb-total { font-weight: 700; font-size: 1.05em; margin-top: 6px; padding-top: 6px; border-top: 1px solid rgba(0,0,0,0.1); }',
